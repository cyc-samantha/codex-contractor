...
assert config["only_mutate"] == ["scripts/lib/code_review_dispatch.py", "scripts/lib/dispatch_contract.py", "scripts/lib/execution_policy.py", "scripts/lib/final_verification.py", "scripts/lib/orchestrator_write_boundary.py", "scripts/lib/pipeline_state.py", "scripts/lib/review_evidence.py", "scripts/lib/review_workflow.py", "scripts/lib/software_engineer_dispatch.py", "scripts/lib/spawn_telemetry.py", "scripts/lib/task_discovery.py", "scripts/lib/task_selection.py", "scripts/lib/writer_claim.py", "scripts/lib/writer_claim_io.py", "scripts/lib/writer_claim_reconciliation.py"]
